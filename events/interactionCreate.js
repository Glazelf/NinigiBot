                    ...
                    case pkmQuizModalId:
                        ...
                        if (pkmQuizModalGuessFormatted == pkmQuizCorrectAnswer) {
                            ...
                            interaction.update({ embeds: pkmQuizMessageObject.embeds, files: pkmQuizMessageObject.files, components: pkmQuizMessageObject.components }).catch(e => {
                                ...
                                return sendMessage({ interaction: interaction, content: "You won but editing the original message failed. This might be because of AutoMod.", embeds: pkmQuizMessageObject.embeds, files: pkmQuizMessageObject.files, components: pkmQuizMessageObject.components, flags: messageFlags.add(MessageFlags.Ephemeral) })
                            });
                        } else {
