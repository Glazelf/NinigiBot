...
export default async (interaction, messageFlags) => {
    ...
    try {
        ...
        return sendMessage({ interaction: interaction, embeds: quoteEmbed as any, flags: messageFlags.add(MessageFlags.Ephemeral)  });
    };
    ...
    return sendMessage({ interaction: interaction, embeds: quoteEmbed as any, flags: messageFlags  });
};
