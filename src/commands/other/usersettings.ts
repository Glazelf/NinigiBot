...
export default async (interaction: any, messageFlags: any) => {
    ...
    switch (interaction.options.getSubcommand()) {
        case "birthday":
            ...
            return sendMessage({ interaction: interaction, content: `Updated your birthday to ${inlineCode(`${day}-${month}`)} (dd-mm).`, flags: messageFlags });
        case "switch":
            ...
            return sendMessage({ interaction: interaction, content: `Updated your Nintendo Switch friend code to ${inlineCode(switchFC)}.`, flags: messageFlags });
