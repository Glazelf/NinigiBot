...
const { User, Shinx, EventTrophy, ShopTrophy } =
  require("../dbObjects/userdata.model")(userdata, Sequelize.DataTypes);
  ...
  try {
    ...
    const trophies = [
      ...
      EventTrophy.upsert({
        ...
        icon: "💥",
        description:
          "Trophy given only to trainers that find pleasure in fighting",
      ...
      EventTrophy.upsert({
        ...
        icon: "❤️‍🔥",
        description:
          "Trophy given only to people whose bond with Shinx is unbreakable",
      ...
      ShopTrophy.upsert({
        ...
        icon: "🏐",
        description:
          "Ancient artifact from the server. It is said that you can hear an echoe when listening closely to its surface.",
        price: 5000,
      }),
      ShopTrophy.upsert({
        ...
        icon: "👻",
        description:
          "This little ghost has been running all the time. He just wants a friend",
        price: 250,
      }),
      ShopTrophy.upsert({
        ...
        icon: "👾",
        description:
          "Bug that lives inside every console that is not Xbox since boxes scare it",
        price: 150,
      }),
      ShopTrophy.upsert({
        ...
        icon: "🤡",
        description:
          "Savage obvious guy, gobbling yogurts. It is said that its name is hidden inside this text.",
        price: 150,
      }),
      ShopTrophy.upsert({
        ...
        icon: "🧠",
        description:
          "Old artifact found by some scientists not much ago. It is said to be used by politicians in the past.",
        price: 250,
      }),
      ShopTrophy.upsert({
        ...
        icon: "👑",
        description:
          "Unknown artifact which is said to have been dropped by a king",
        price: 250,
      }),
      ShopTrophy.upsert({
        trophy_id: "Ice Face",
      ...
      ShopTrophy.upsert({
        ...
        icon: "🐒",
        description:
          "A monkey that used to be human. He really rejected humanity",
        price: 500,
      }),
      ShopTrophy.upsert({
        ...
        icon: "🗡️",
        description:
          "Something that Zacian lost last time it was busy rotating",
        price: 1500,
      }),
      ShopTrophy.upsert({
        ...
        icon: "🛡️",
        description:
          "Something that Zamacenta lost last time it was busy rotating",
        price: 1500,
      }),
      ShopTrophy.upsert({
