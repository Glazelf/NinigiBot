module.exports = (sequelize, DataTypes) => {
  ...
  User.belongsToMany(EventTrophy, {
    through: "EventTrophyUser",
    timestamps: false,
  });
  EventTrophy.belongsToMany(User, {
    through: "EventTrophyUser",
    timestamps: false,
  });
  User.belongsToMany(ShopTrophy, {
    through: "ShopTrophyUser",
    timestamps: false,
  });
  ShopTrophy.belongsToMany(User, {
    through: "ShopTrophyUser",
    timestamps: false,
  });
