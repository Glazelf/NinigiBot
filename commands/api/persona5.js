    ...
    try {
        ...
        switch (interaction.options.getSubcommand()) {
            case "persona":
                ...
                if (!personaObject) return sendMessage({ client: interaction.client, interaction: interaction, content: `Could not find that Persona.` });
            ...
            case "skill":
                ...
                if (!skillObject || skillObject.element == "trait") return sendMessage({ client: interaction.client, interaction: interaction, content: `Could not find that skill.` });
                let skillPersonas = "";
            ...
            case "trait":
                ...
                if (!traitObject || traitObject.element !== "trait") return sendMessage({ client: interaction.client, interaction: interaction, content: `Could not find that trait.` });
            ...
            case "item":
                ...
                if (!itemObject) return sendMessage({ client: interaction.client, interaction: interaction, content: `Could not find that item.` });
        ...
        return sendMessage({ client: interaction.client, interaction: interaction, embeds: p5Embed, ephemeral: ephemeral, components: buttonArray });
