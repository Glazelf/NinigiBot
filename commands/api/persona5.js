exports.run = async (client, interaction) => {
  ...
  try {
    ...
    eval(
      fs.readFileSync(
        "submodules/persona5_calculator/data/Data5Royal.js",
        "utf8",
      ),
    );
    ...
    eval(
      fs.readFileSync(
        "submodules/persona5_calculator/data/PersonaDataRoyal.js",
        "utf8",
      ),
    );
    ...
    eval(
      fs.readFileSync(
        "submodules/persona5_calculator/data/SkillDataRoyal.js",
        "utf8",
      ),
    );
    ...
    eval(
      fs.readFileSync(
        "submodules/persona5_calculator/data/ItemDataRoyal.js",
        "utf8",
      ),
    );
    let p5Embed = new Discord.MessageEmbed().setColor(globalVars.embedColor);
    ...
    switch (interaction.options.getSubcommand()) {
      case "persona":
        ...
        if (!personaObject)
          return sendMessage({
            ...
            content: `Could not find that Persona.`,
          });
        ...
        // Weaknesses string
        let elementalMatchup = `Physical: ${getWeaknessString(
          personaObject.elems[0],
        )}\nGun: ${getWeaknessString(
          personaObject.elems[1],
        )}\nFire: ${getWeaknessString(
          personaObject.elems[2],
        )}\nIce: ${getWeaknessString(
          personaObject.elems[3],
        )}\nElectric: ${getWeaknessString(
          personaObject.elems[4],
        )}\nWind: ${getWeaknessString(
          personaObject.elems[5],
        )}\nPsychic: ${getWeaknessString(
          personaObject.elems[6],
        )}\nNuclear: ${getWeaknessString(
          personaObject.elems[7],
        )}\nBless: ${getWeaknessString(
          personaObject.elems[8],
      ...
      case "skill":
        ...
        if (!skillObject || skillObject.element == "trait")
          return sendMessage({
            client: client,
            interaction: interaction,
            content: `Could not find that skill.`,
          });
        let skillPersonas = "";
        ...
        p5Embed
          .setAuthor({
            name: `${skillInput} (${capitalizeString(skillObject.element)})`,
          })
      ...
      case "trait":
        ...
        if (!traitObject || traitObject.element !== "trait")
          return sendMessage({
            client: client,
            interaction: interaction,
            content: `Could not find that trait.`,
          });
      ...
      case "item":
        ...
        if (!itemObject)
          return sendMessage({
            client: client,
            interaction: interaction,
            content: `Could not find that item.`,
          });
