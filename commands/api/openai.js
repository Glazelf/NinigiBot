exports.run = async (client, interaction) => {
    ...
    try {
        ...
        return sendMessage({ client: client, interaction: interaction, content: `This command is currently unavailable since you guys used up the free trial credit for OpenAI.\nWe are currently [looking into the options](<https://github.com/Glazelf/NinigiBot/issues/490>) and [OpenAI pricing plans](<https://openai.com/api/pricing/>).\nI am currently making absolutely no money with this bot, but I am paying for quite a few services including hosting. A pay-as-you-go AI plan would rack up quite a cost with ${client.user.username} being in ${client.guilds.cache.size} servers.\nConsider donating at [Paypal](<https://www.paypal.com/paypalme/glazelf>) or even [Github](<https://github.com/sponsors/Glazelf>), it would mean a bunch to me and enable stupid features like this.\nThanks, it means a lot you're even using this bot, but money goes a long way too!` });
