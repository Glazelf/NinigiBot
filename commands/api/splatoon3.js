    ...
    try {
        ...
        switch (interaction.options.getSubcommand()) {
            case "clothing":
                ...
                switch (clothingType) {
                    ...
                    case "Shoes":
                        ...
                        break;
                    default:
                        return sendMessage({ client: interaction.client, interaction: interaction, content: clothingFailedString });
                };
                let clothingObject = await Object.values(selectedClothesJSON).find(clothing => clothing.__RowId.includes(inputID));
                if (!clothingObject) return sendMessage({ client: interaction.client, interaction: interaction, content: clothingFailedString });
            ...
            case "weapon":
                ...
                if (!weaponObject) return sendMessage({ client: interaction.client, interaction: interaction, content: `Couldn't find that weapon. Make sure you select an autocomplete option.` });
            ...
            case "subweapon":
                ...
                if (subweaponMatches.length < 1) return sendMessage({ client: interaction.client, interaction: interaction, content: `Couldn't find that subweapon. Make sure you select an autocomplete option.` });
            ...
            case "special":
                ...
                if (specialWeaponMatches.length < 1) return sendMessage({ client: interaction.client, interaction: interaction, content: `Couldn't find that special weapon. Make sure you select an autocomplete option.` });
            ...
            case "schedule":
                ...
                if (responseSchedules.status != 200) return sendMessage({ client: interaction.client, interaction: interaction, content: `Error occurred getting schedule data. Please try again later.` });
                ...
                if (!allowedModes.includes(inputMode)) return sendMessage({ client: interaction.client, interaction: interaction, content: `That mode either does not exist or is not currently available ingame.` });
            ...
            case "splatnet":
                ...
                if (responseSplatnet.status != 200) return sendMessage({ client: interaction.client, interaction: interaction, content: `Error occurred getting SplatNet3 data. Please try again later.` });
            ...
            case "splatfests":
                ...
                return sendMessage({ client: interaction.client, interaction: interaction, embeds: splatfestReplyObject.embeds, components: splatfestReplyObject.components, ephemeral: ephemeral });
                break;
            case "replay":
        ...
        return sendMessage({ client: interaction.client, interaction: interaction, embeds: splat3Embed, ephemeral: ephemeral });
