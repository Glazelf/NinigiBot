module.exports.run = async (client, message, args) => {
    ...
    try {
        ...
        if (!message.channel.permissionsFor(message.guild.me).has("MANAGE_ROLES")) return message.channel.send(`> I don't have permission to manage channels, ${message.author}.`);
