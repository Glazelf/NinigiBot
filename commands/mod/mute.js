...
export default async (interaction, ephemeral) => {
    ...
    if (targetRole.position >= userRole.position) return sendMessage({ interaction: interaction, content: `You can not mute ${user.username} because their highest role (${targetRole.name}) is higher than yours (${userRole.name}).` });
