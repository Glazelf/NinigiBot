exports.run = async (client, interaction) => {
  ...
  try {
    ...
    const descriptionInput = new Discord.TextInputComponent()
      ...
      .setPlaceholder(
        "I saw a spider with 10 legs, I don't think that's normal!",
      )
      .setStyle("PARAGRAPH")
      .setMinLength(10)
      .setMaxLength(1024)
    ...
    const actionRow2 = new Discord.MessageActionRow().addComponents(
      descriptionInput,
    );
    const actionRow3 = new Discord.MessageActionRow().addComponents(
      reproduceInput,
    );
    const actionRow4 = new Discord.MessageActionRow().addComponents(
      behaviourInput,
    );
    const actionRow5 = new Discord.MessageActionRow().addComponents(
      contextInput,
    );
