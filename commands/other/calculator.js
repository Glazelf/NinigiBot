exports.run = async (client, interaction, args = interaction.options._hoistedOptions) => {
    ...
    try {
        ...
        if (!args[0]) return sendMessage({ client: client, interaction: interaction, content: noInputString });
        ...
        try {
            ...
            // console.log(e);
            return sendMessage({ client: client, interaction: interaction, content: `You need to provide a valid input.` });
        };
