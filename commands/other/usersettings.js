...
export default async (interaction) => {
    switch (interaction.options.getSubcommand()) {
        ...
        case "switch":
            ...
            if (!switchFC) {
                if (switchCodeGet) return sendMessage({ interaction: interaction, content: `${formatName(interaction.user.username)}'s Nintendo Switch friend code is ${bold(switchCodeGet)}.` });
