    ...
    switch (interaction.options.getSubcommand()) {
      case "stock":
        ...
        trophies.forEach((trophy) => {
          let trophy_header = {
            name: "\u200B",
            value: `${trophy.icon} **${trophy.trophy_id}**`,
            inline: true,
          };
          let trophy_price = {
            name: "\u200B",
      ...
      case "buy":
        ...
        res = await api_trophy.buyShopTrophy(
          master.id,
          trophy_name.toLowerCase(),
        );
        switch (res) {
          case "NoTrophy":
      ...
      case "list":
        let trophy_slice =
          await require("../../util/trophies/getTrophyEmbedSlice")(0);
        return sendMessage({
          client: client,
          interaction: interaction,
      ...
      case "ask":
        ...
        let isShop = true;
        if (!res) {
          res = await api_trophy.getEventTrophyWithName(trophy_name);
          isShop = false;
        }
        if (!res) {
          return sendMessage({
